...
public class ShopView2 {
    ...
    public ShopView2(Character character, Shop shop) {
        int yAdder = 0;
        ...
        page1Button = new JButton("Go to page 1");
        page1Button.setFocusPainted(false);
        page1Button.setBounds(300,35,200,30);
        page1Button.setFont(new Font("Garamond", Font.BOLD,15));
        page1Button.setBorder(BorderFactory.createEtchedBorder());
    ...
    public boolean getCanPurchase(int index, Character character, Shop shop) {
        return character.getRunes() >= shop.getItemCost(index + 15);
    }
    public void addPage1ActionListener(ActionListener listener) {
        page1Button.addActionListener(listener);
    }
